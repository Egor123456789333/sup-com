...
import { createTheory, fetchChapter, updateTheory } from "../http/theoryApi";
...
const UpdateTheory = () => {
  ...
  useEffect(() => {
    fetchChapter(courseId).then((data) => {
      setTheory(data);
      console.log(htmlToDraft(data.text));
